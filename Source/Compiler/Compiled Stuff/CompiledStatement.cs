...
{
    public required ICompiledFunction Function { get; init; }
    public required ImmutableArray<CompiledPassedArgument> Arguments { get; init; }
...
public class CompiledExternalFunctionCall : CompiledStatementWithValue
{
    ...
    public required ICompiledFunction Declaration { get; init; }
    public required ImmutableArray<CompiledPassedArgument> Arguments { get; init; }
...
{
    public CompiledGeneralFunction? Destructor { get; init; }
    public CompiledFunction? Deallocator { get; init; }
...
{
    public required CompiledConstructor Function { get; init; }
...
{
    public required CompiledGeneralFunction Function { get; init; }
    public required CompiledStatementWithValue Value { get; init; }
...
{
    public required CompiledFunction Function { get; init; }

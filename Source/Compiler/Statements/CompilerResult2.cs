...
public readonly struct CompilerResult2
{
    ...
    public readonly ImmutableArray<CompiledStatement> Statements2;
    ...
    public readonly string Stringify()
    {
        ...
        foreach (CompiledStatement statement in Statements2)
        {
    ...
    public static CompilerResult2 MakeEmpty(Uri file) => new(
    ...
    public CompilerResult2(
        ...
        Uri file,
        bool isInteractive,
        ImmutableArray<CompiledStatement> statements2,

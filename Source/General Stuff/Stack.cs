...
public class Stack<T> : IReadOnlyStack<T>, ICollection<T>
{
    ...
    public void Pop(int count)
    {
        ...
        { throw new InvalidOperationException($"Count ({count}) is larger than the number of items in the stack ({stack.Count})"); }
    ...
    public virtual void PushIf<TItem>(Nullable<TItem> item) where TItem : struct, T
    {

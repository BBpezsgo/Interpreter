...
public class BrainfuckTests
{
    ...
    [TestMethod, Timeout(Timeout), Ignore] public void Test62() => Utils.GetTest(62).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test63() => Utils.GetTest(63).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test64() => Utils.GetTest(64).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test65() => Utils.GetTest(65).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test66() => Utils.GetTest(66).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test67() => Utils.GetTest(67).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test68() => Utils.GetTest(68).DoBrainfuck();
    [TestMethod, Timeout(Timeout), Ignore] public void Test69() => Utils.GetTest(69).DoBrainfuck();

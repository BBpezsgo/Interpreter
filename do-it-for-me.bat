...
echo Compressing ...
cd bin/Release/net7.0/win-x86/publish
tar.exe -a -cf ../BBC_win86_jit.zip *
cd ../../../../../
echo Uploading ...
call upload.bat "D:/Program Files/BBCodeProject/BBCode/bin/Release/net7.0/win-x86/BBC_win86_jit.zip"
cd "D:/Program Files/BBCodeProject/BBCode/"
echo Cleaning ...
del "D:/Program Files/BBCodeProject/BBCode/bin/Release/net7.0/win-x86/BBC_win86_jit.zip"
echo Ok
...
cd ../../../../../
echo Uploading ...
call upload.bat "D:/Program Files/BBCodeProject/BBCode/bin/Release/net7.0/win-x86/BBC_win86_aot.zip"
cd "D:/Program Files/BBCodeProject/BBCode/"
echo Cleaning ...
del "D:/Program Files/BBCodeProject/BBCode/bin/Release/net7.0/win-x86/BBC_win86_aot.zip"
echo Ok
